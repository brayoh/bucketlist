...
import AddItemDialog from "../components/modals/CreateModal";
...
const columnData = [
  { id: 'item_id', numeric: true, disablePadding: false, label: 'Item id' },
...
class ItemsContainer extends React.Component {
  ...
  handleAddItem = (e : Object) => {
    ...
    // send data to API
    this.props.addItem({name, bucket_id, token});
  }
  ...
  handleEditItem = (e : Object) =>  {
    ...
    const {token} = this.props.whoami;
    // send data to API
    this.props.updateItem({item_id, name, bucket_id, done, token});
  }
  ...
  handleDeleteItem = (e : Object) => {
    ...
    // send data to API
    this.props.deleteItem({item_id, bucket_id, token});
  }
