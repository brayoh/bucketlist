...
// modals
import AddBucketDialog from "../../components/modals/AddModal";
...
class DashboardContainer extends Component {
  ...
  handleAddBucket(e : Object) {
    ...
    // send data to API
    this.props.addBucket({name, description});
  }
  ...
  handleEditBucket(e : Object) {
    ...
    // send data to API
    this.props.updateBucket({bucket_id, name, description, done});
  }
  ...
  handleDeleteBucket(e : Object) {
    ...
    // send data to API
    this.props.deleteBucket({bucket_id});
  }
